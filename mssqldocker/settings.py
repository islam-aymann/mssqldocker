"""
Django settings for mssqldocker project.
...
SECRET_KEY = 'django-insecure-y%edhef*t=0+-(#rb@f-r_+0wr2inh%%j-r*-8j)!k_#$mdkrz'
...
WSGI_APPLICATION = 'mssqldocker.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get("MSSQL_HOST", "db"),
